"""Source: https://github.com/ecs-vlc/FMix/blob/master/models/pyramid.py
"""
...
class ShakeDropFunction(torch.autograd.Function):
    ...
    def backward(ctx, grad_output):
        ...
        if gate.item() == 0:
            ...
            beta = torch.rand(grad_output.size(0))
...
class aa_PyramidNet(nn.Module):
    def __init__(self, dataset='cifar10', depth=272, alpha=200, num_classes=10, bottleneck=True):
...
def aa_PyramidNet272200(**kwargs):
    return aa_PyramidNet(depth=272, alpha=200, **kwargs)

aa_pyramidnet272200 = aa_PyramidNet272200